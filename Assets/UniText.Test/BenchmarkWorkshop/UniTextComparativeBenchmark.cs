...
#pragma warning restore CS0414
    ...
    private IEnumerator RunComparativeCoroutine()
    {
        ...
        results.AppendLine("\n▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓");
        results.AppendLine("                        UNITEXT TESTS (SINGLE-THREADED)");
        results.AppendLine("▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓");
        Debug.Log("=== STARTING UNITEXT TESTS (SINGLE-THREADED) ===");

        currentTest = "UniText (Single-Threaded)";
        yield return uniTextBenchmark.RunBenchmarkCoroutine(silent: true, parallel: false);
        AppendBenchmarkResults(uniTextBenchmark);

        results.AppendLine("\n▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓");
        results.AppendLine("                          UNITEXT TESTS (PARALLEL)");
        results.AppendLine("▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓");
        Debug.Log("=== STARTING UNITEXT TESTS (PARALLEL) ===");

        currentTest = "UniText (Parallel)";
        yield return uniTextBenchmark.RunBenchmarkCoroutine(silent: true, parallel: true);
        AppendBenchmarkResults(uniTextBenchmark);
